...
import com.example.kuou.module.search.database.HistoryWordDatabaseManager;
...
public class WeatherActivity extends BaseActivity implements SearchCityRecycleViewAdapter.ISendSearchCityDataToWeatherActivityListener, WeatherDataCallback {
    ...
    private HistoryWordDatabaseManager mDatabaseManager = HistoryWordDatabaseManager.createInstance();
    ...
    public void postSearchCityData(SearchCityBean.LocationBean locationBean) {
        ...
        if (!mDatabaseManager.isExitKey(this.cityName)) {
            ContentValues contentValues = new ContentValues();
            contentValues.put("history_key", this.cityName);
            contentValues.put("history_value", this.cityName);
