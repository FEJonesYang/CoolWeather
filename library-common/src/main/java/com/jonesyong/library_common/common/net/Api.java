package com.jonesyong.library_common.common.net;
...
public class Api {
    ...
    // 某一地区景点的天气数据
    public static final String queryPOIInfo = geoBaseUrl + "/v2/poi/lookup?type=scenic&location=";
    ...
    public static final String forecast7Day = devBaseUrl + "/v7/weather/7d?location=";

    // 逐天天气数据--15天 https://devapi.qweather.com/v7/weather/15d?location=101010100&key=575a4dd45c9f46ca833a259f953c76b3
    public static final String forecast15Day = devBaseUrl + "/v7/weather/15d?location=";
    ...
    public static final String historyWeather = devBaseUrl + "/v7/historical/weather?location=";

    // 历史空气质量数据查询 https://dev.qweather.com/docs/api/historical/historical-air/
    public static final String historyAirCondition = devBaseUrl + "/v7/historical/air?location=";
