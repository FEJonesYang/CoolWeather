...
import com.example.kuou.module.search.database.SearchHistoryDataBaseHelper;
...
public class SearchCityPresenter {
    ...
    public void handleHotCity(HotCityResponse hotCityResponse) {
        ...
        for (int i = 0; i < listDTOS.size(); i++) {
            ...
            childView.setOnClickListener((l) -> {
                ...
                mSearchCityActivity.startActivity(intent);
            });
    ...
    public void initEvent() {
        ...
        mAdapter = new SearchCityRecycleViewAdapter(mSearchCityActivity);
    ...
    private void queryDatabase() {
        ...
        while (cursor.moveToNext()) {
            String value = cursor.getString(cursor.getColumnIndex("history_key"));
